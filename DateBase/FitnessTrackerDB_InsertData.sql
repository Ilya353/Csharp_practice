...
VALUES 
    ...
    ('Бег', 'Кардио', 0, GETDATE(), GETDATE()),  -- Неактивная программа
    ('Пилатес', 'Растяжка', 1, GETDATE(), GETDATE()),
    ('Кроссфит', 'Силовая', 0, GETDATE(), GETDATE()), -- Неактивная программа
...
VALUES 
    -- Упражнения для "Силовая тренировка" (ProgramId = 1)
    ...
    -- Упражнения для "Кардио тренировка" (ProgramId = 2)
    ('Бег на дорожке', 2, 1, GETDATE(), GETDATE()),
    ('Велотренажер', 2, 1, GETDATE(), GETDATE()),
    ('Эллиптический тренажер', 2, 0, GETDATE(), GETDATE()), -- Неактивное
    ...
    ('Поза моста', 3, 0, GETDATE(), GETDATE()), -- Неактивное
    ('Поза голубя', 3, 1, GETDATE(), GETDATE()),
    
    -- Упражнения для "Функциональный тренинг" (ProgramId = 4)
    ...
    ('Запрыгивания на тумбу', 4, 0, GETDATE(), GETDATE()), -- Неактивное
    
    -- Упражнения для "Бег" (ProgramId = 5 - неактивная программа)
    ('Бег 5 км', 5, 1, GETDATE(), GETDATE()),
    ('Бег 10 км', 5, 0, GETDATE(), GETDATE()),
    
    -- Упражнения для "Пилатес" (ProgramId = 6)
    ('Сотня', 6, 1, GETDATE(), GETDATE()),
    ('Ножницы', 6, 1, GETDATE(), GETDATE()),
    ('Плавающий', 6, 1, GETDATE(), GETDATE()),
    
    -- Упражнения для "Кроссфит" (ProgramId = 7 - неактивная программа)
    ('Рывок штанги', 7, 1, GETDATE(), GETDATE()),
    ('Махи гирей', 7, 0, GETDATE(), GETDATE()),
    
    -- Упражнения для "Плавание" (ProgramId = 8)
...
VALUES 
    -- Активности за сегодня (15-20 минут назад)
    ...
    -- Активности за 5 дней назад (для красного стикера > 90 минут)
    ...
    -- Активности за 10 дней назад (нормальные тренировки)
